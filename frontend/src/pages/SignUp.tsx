  ...
  return <div className='grid grid-cols-2 h-screen'>
      ...
      <section className='flex flex-col justify-center px-[15%]'>
        ...
        <section className='flex justify-between max-w-sm'>
          <input type='text' placeholder='first Name' className='bg-gray-200 w-[185px] px-3 py-3 rounded-md focus:outline-none mt-10'/>
          <input type='text' placeholder='Last Name' className='bg-gray-200 w-[185px] px-3 py-3 rounded-md focus:outline-none mt-10'/>
        </section>

        <input type='email' placeholder='Email' className='bg-gray-200 max-w-sm px-3 py-3 rounded-md focus:outline-none mt-5'/>

        <input type='password' placeholder='Password' className='bg-gray-200 max-w-sm px-3 py-3 rounded-md focus:outline-none mt-5'/>
        ...
        <button className='mt-10 px-6 py-3 max-w-sm bg-blue-500 font-semibold rounded-lg text-white hover:bg-blue-400 focus:outline-none'>Sign Up</button>
